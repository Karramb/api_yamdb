# Generated by Django 3.2 on 2024-11-18 20:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='^[-a-zA-Z0-9_]+$')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='reviews.title')),
            ],
            options={
                'verbose_name': 'Отзыв',
